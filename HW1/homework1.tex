...
\begin{enumerate}
    ...
    \item \includegraphics[scale=0.7]{part_1.png}
...
\begin{enumerate}
    \item \includegraphics[scale=0.5]{k1.png}
...
\begin{enumerate}
    \item \includegraphics[scale=0.8]{r1.png}
    
    \item \includegraphics[scale=0.8]{r2.png}
